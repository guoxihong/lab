...
<body>
   <h1 class="h-title">查询学生信息</h1>
      <form class="layui-form" action="/lab/index.php/Admin/Person/stusearch" method="post">
         <div class="layui-form-item">
            <label class="layui-form-label">学号</label>
            <div class="layui-input-block">
               <input type="text" name="st_no" placeholder="请输入学号查询" autocomplete="off" class="layui-input input-long">
           ...
           <table class="layui-table table2excel">
              ...
              <tbody>
                 <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
  	                  ...
  	                  <td style="mso-number-format:'\@';"><?php echo ($vo["st_no"]); ?></td>
                      <td><?php echo ($vo["st_pwd"]); ?></td>
                      <td><?php echo ($vo["st_major"]); ?></td>
                      <td><?php echo ($vo["st_phone"]); ?></td>
  	                  <td><?php echo ($vo["st_usertype"]); ?></td>
  	                  <td style="mso-number-format:'\@';"><?php echo ($vo["st_identity"]); ?></td>
  	                  <td><a href="/lab/index.php/Admin/Person/stuupdate/st_id/<?php echo ($vo["st_id"]); ?>">编辑</a></td>
  	                  <td><a href="/lab/index.php/Admin/Person/studel/st_id/<?php echo ($vo["st_id"]); ?>" onclick="return confirm('确定要删除吗')">删除</a></td>
