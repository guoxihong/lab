         ...
         <table class="layui-table">
            ...
            <tbody>
               <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
	                  <td><?php echo ($i); ?></td>
	                  <td><?php echo ($vo["an_content"]); ?></td>
	                  <td><a href="/lab/index.php/Admin/Lab/annmupdate/an_id/<?php echo ($vo["an_id"]); ?>">编辑</a></td>
	                  <td><a href="/lab/index.php/Admin/Lab/annmdel/an_id/<?php echo ($vo["an_id"]); ?>" onclick="return confirm('确定要删除吗')">删除</a></td>
