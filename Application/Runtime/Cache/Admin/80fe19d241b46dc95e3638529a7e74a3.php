      ...
      <form class="layui-form" action="/lab/index.php/Admin/Person/stusearch" method="post">
        ...
        <div class="table-box">
           <table class="layui-table">
              ...
              <tbody>
                 <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo[af_type] == '教师'): ?><tr>
                            <td><?php echo ($i); ?></td>
